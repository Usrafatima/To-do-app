...
TaskPilot started as a humble command-line todo app and evolved into a fully-fledged, event-driven microservices system.  
This journey showcases progressive innovation, from a simple terminal tool to a resilient Kubernetes-powered architecture.
...
**Key Features:**
- **Microservice Split:**
  1. Task Service: Core CRUD operations.
  2. Audit Service: Immutable activity logs.
  3. Reminder Service: Time-based notifications.
  4. Recurring Service: Automates daily/weekly task creation.
